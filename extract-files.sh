...
# debugfs requires the rdump destination to exist.  Keep stderr visible so a
# corrupt image or unsupported ext4 feature is actionable in CI logs.
debugfs -R "rdump / $PROPRIETARY_DIR/vendor" "$IMAGE" >/dev/null
